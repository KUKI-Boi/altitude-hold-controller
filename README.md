# Altitude Hold Controller using Cascade PID (3DOF Aircraft)
...
The simulation relies on the **3DOF longitudinal aircraft model** provided by the Aerospace Blockset.
...
1. Altitude reference is compared with measured altitude.
2. Altitude PID controller generates a pitch reference.
3. Pitch PID controller generates elevator deflection.
4. Aircraft model responds to elevator input.
5. Updated altitude is fed back to the controller.
